...
<div class="container">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="type" name="type" VALUE="Truck" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="tolltax" name="tolltax" VALUE="150" required>
        </div>
